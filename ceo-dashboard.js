(() => {
  ...
  function renderAlerts() {
    ...
    q('#attentionSubhead').textContent = alerts.length ? `Срочные: ${summary.critical || 0}. Плановые: ${summary.risk || 0}. За пределами лимита: ${summary.deferred || 0}, из них срочных ${summary.deferred_critical || 0}. Холодная база для пакетной обработки: ${summary.backlog || 0}.` : 'По доступным данным продажи, проекты и решения не дают критических сигналов.';
