...
(() => {
 ...
 const social=document.createElement('section');social.className='panel';social.innerHTML=`<h3>Telegram и VK</h3><p>Переходы на сайт из соцсетей доступны в отчёте Метрики. Охваты, подписчики и реакции требуют данных самих площадок.</p><div class="channel-grid"><article><h3>Telegram</h3><strong>Нативная статистика не подключена</strong><p>Нужны: подписчики и прирост, охват публикаций за 24 / 48 часов, пересылки, реакции, переходы по UTM, заявки.</p><p>Следующее действие: подключить экспорт статистики канала или источник с доступом к его аналитике. Токен бота сам по себе не даёт полную историю просмотров.</p></article><article><h3>VK</h3><strong>Нативная статистика не подключена</strong><p>Нужны: охват, посетители, подписки и отписки, реакции, переходы, заявки по публикациям.</p><p>Следующее действие: настроить серверный доступ к статистике сообщества и указать его ID. Переходы на сайт размечать utm_source=vk.</p></article></div><p class="history-caveat">Отсутствие источника не означает нулевой результат. utm_source=telegram / vk, utm_medium=social, utm_campaign=название_кампании, utm_content=идентификатор_поста.</p>`;
